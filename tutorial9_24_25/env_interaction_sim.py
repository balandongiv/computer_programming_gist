...
def move_robots(canvas, bots, passive_components, dirt_counter, moves, max_moves, move_delay,window):
    ...
    if moves > max_moves:
        ...
        window.root.after(100,  window.root.destroy)  # Schedule window to close after this call finishes
...
if __name__ == "__main__":
    collected_dirt=run_simulation(NUM_BOTS = 30,
         MAX_MOVES = 4)
    print(f'Total dirt collected: {collected_dirt}')